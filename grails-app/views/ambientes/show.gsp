            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: ambientesInstance, field: "id")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.fisicaVirtual.label" default="Fisica Virtual" /></td>
                            
                            <td valign="top" class="value">${ambientesInstance?.fisicaVirtual?.encodeAsHTML()}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.objLocal.label" default="Obj Local" /></td>
                            
                            <td valign="top" class="value"><g:link controller="locais" action="show" id="${ambientesInstance?.objLocal?.id}">${ambientesInstance?.objLocal?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.objSO.label" default="Obj SO" /></td>
                            
                            <td valign="top" class="value"><g:link controller="sistemasOperacionais" action="show" id="${ambientesInstance?.objSO?.id}">${ambientesInstance?.objSO?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.descricaoAmbiente.label" default="Descricao Ambiente" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: ambientesInstance, field: "descricaoAmbiente")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.memoriaTotal.label" default="Memoria Total" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: ambientesInstance, field: "memoriaTotal")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="ambientes.objInstancia.label" default="Obj Instancia" /></td>
