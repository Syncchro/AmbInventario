            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="software.versao.label" default="Versao" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: softwareInstance, field: "versao")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="software.ambientes.label" default="Ambientes" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="software.instancias.label" default="Instancias" /></td>
